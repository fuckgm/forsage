    ...
    <div class="row">
        ...
        <div class="col-md-8 nav-wrapper">
            <ul class="nav">
                <li>
                    ...
                    <ul>
                        <li <?php if($page == 'Dashboard'){echo "active";} ?>>
                            <a href="<?php echo 'http://localhost/forsage/'.'dashboard';  ?>">
                                The main panel                            </a>
                        </li>
                        <li <?php if($page == 'Partners'){echo "active";} ?>>
                            <a href="<?php echo 'http://localhost/forsage/'.'dashboard/partners.php';  ?>">
                                Partners                            </a>
                        </li>
                        <li <?php if($page == 'Statistics'){echo "active";} ?>>
                            <a href="<?php echo 'http://localhost/forsage/'.'dashboard/statistics.php';  ?>">
                                Statistics                            </a>
                        </li>
                        <li <?php if($page == 'Dashboard'){echo "active";} ?>>
                            <a href="/user/target/">
                ...
                <li >
                    <a href="<?php echo 'http://localhost/forsage/'.'dashboard/information.php';  ?>">Information</a>
                    <ul>
                        <li>
                            <a href="/guide/">
                                Instructions                            </a>
