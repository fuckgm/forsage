      ...
      <div class="col">
         <div class="border-gradient">
            <div class="border-gradient_content">
               ...
               <form class="bg-black_transparent filter-partners" method="POST" action="<?php echo SITE_URL.'dashboard/uplines.php'?>">
                  ...
                  Apply                    </button>
                  <a href="<?php echo SITE_URL.'dashboard/uplines.php';?>" class="btn btn-secondary">
                  Reset filter                    </a>
               </form>
